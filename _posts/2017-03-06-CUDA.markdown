...
* Minimize divergent warps caused by branching. Design the application such that the code within a warp branches in the same way.
* Use compiler to un-roll loop.
